"""
Django settings for walkPets project.
...
SECRET_KEY = 'django-insecure-vge=baq6oi-r=rfs9$cmjw4*5@_is1c^u5ay6sfmu-+%#r6!!3'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'users.context_processors.top_reviews',
            ],
        },
    },
]

WSGI_APPLICATION = 'walkPets.wsgi.application'
